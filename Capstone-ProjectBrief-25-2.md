...
| (2) 팀 번호/이름 | 13-e시크 |
| (3) 구성원 | 
이지원 (2176297): 리더, 프로젝트 매니저(프로젝트 기획 및 일정 관리, 협력사와의 커뮤니케이션 총괄, 웹 시각화 및 문서화 작업 주도) <br><br>김도희 (2170009): 팀원, 소프트웨어 엔지니어(데이터 수집 및 전처리, 외부 API(Open-Meteo 등) 연동, 데이터베이스 파이프라인 개발) <br><br>변아연 (2271032): 팀원, 소프트웨어 엔지니어(머신러닝 모델 학습 및 하이퍼파라미터 튜닝, 성능 평가, 분석 리포트 작성) |
| (4) 지도교수 | 이형준 교수 |
| (5) 트랙  | 산학 |
